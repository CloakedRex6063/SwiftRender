...
int main()
{
    ...
    Swift::BufferCreateInfo buffer_info = {
        ...
        .Usage = Swift::BufferUsage::eVertexBuffer | Swift::BufferUsage::eTransferSrc,
        .InitialData = vertices.data(),
    };
    const auto exp_vertex_buffer = Swift::CreateBuffer(buffer_info);
    const auto vertex_buffer = Swift::ThrowOnFail(exp_vertex_buffer, "Failed to create buffer.");
